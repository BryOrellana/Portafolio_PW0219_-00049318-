...
let carnet_regex = new RegExp('[0-9]{8}') /*Para tomar digitos de 0-9 y que solo se puedan ingresar 8 digitos*/

/*Funciones*/
let addStudent = (carnet, schedule, late)=>{
    let new_row = document.createElement('tr')
    let datetime = new Date() /*registro de fechas*/
...
submit_btn.addEventListener('click',()=>{
    ...
    let late = parseLetSwitch(late_switch.checked)
